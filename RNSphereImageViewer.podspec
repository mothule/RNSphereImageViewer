#
#  Be sure to run `pod spec lint RNSphereImageViewer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  This library can watch a spherical image. like the THETA.
                   DESC

  s.homepage     = "https://github.com/mothule/RNSphereImageViewer"
  ...
  s.source       = { :git => "https://github.com/mothule/RNSphereImageViewer.git", :tag => "#{s.version}" }
